...
export interface getJobInfoInterface{
    jobId:string,
      ...
      setIsProposalSent:Dispatch<SetStateAction<boolean>>,
...
export  interface fetchJobsForYouInterface{
   lastCursorPromoted:string,
   promotedPrevDocs:string[],
   lastCursorRegular:string,
   regularPrevDocs:string[],
   setLastCursorPromoted:Dispatch<SetStateAction<string>>,
   setPromotedPrevDocs:Dispatch<SetStateAction<string[]>>,
   setLastCursorRegular:Dispatch<SetStateAction<string>>,
   setRegularPrevDocs:Dispatch<SetStateAction<string[]>>,
   setPromotedHasMore:Dispatch<SetStateAction<boolean>>,
   setRegularHasMore:Dispatch<SetStateAction<boolean>>,
