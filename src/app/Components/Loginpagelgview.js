...
const Loginpagelgview =()=>{
 ...
 return(
    ...
    <h1 className=" lg:absolute lg:top-[6.6rem] xl:top-20 mt-3 text-black font-semibold lg:text-3xl lg:ml-32 xl:text-4xl xl:ml-52 ">{translate('where')} <span className="bg-[white] text-[#ff7300] px-3 text-center mr-1"> {translate('Talents')} </span> {translate('meets')}</h1>
