...
const CandidatesList = ({  isCreator, candidates,hasMore,setHasMoreTrigger,candidateErrorType }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="h-[600px] overflow-y-auto overflow-x-hidden pr-2 custom-scrollbar">
        <div className="grid grid-cols-1 gap-6">
          {
          candidateErrorType!=='none' ? 
          <JobError type={candidateErrorType}></JobError>
          :
          candidates.length == 0 ? 
