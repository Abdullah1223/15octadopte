...
const Loginpagesmview = ()=>{
   ...
   return( 
    ...
    <h1 className="mt-1 text-black font-semibold text-2xl sm:text-4xl md:text-5xl ">{translate('where')} <span className="bg-[white] text-[#ff7300] px-3 text-center mr-1"> {translate('Talent')} </span> {translate('meets')}</h1>
