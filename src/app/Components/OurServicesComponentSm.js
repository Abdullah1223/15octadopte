         ...
         <div className=" mt-4  w-44">
          <img src="/iphone (1).png"></img>
                ...
                <div className="self-center mt-6"> <Image src={'/magnifying-glass.png'} width={40} height={40}></Image></div>
                 ...
                 <h1 className=" text-2xl mt-2 font-bold text-center">{translate('skill_based_matching')}</h1> 
                 <h1 className="break-words   text-base px-4 mt-2  text-center">{translate('skill_based_matching_subheading')}</h1>
                 
                 <div className="self-center mt-10"> <Image src={'/magnifying-glass.png'} width={40} height={40}></Image></div>
                 <h1 className=" text-2xl mt-2 font-bold text-center">{translate('skill_based_matching')}</h1> 
                 <h1 className="break-words  mb-4 text-base px-4 mt-2  text-center">{translate('skill_based_matching_subheading')}</h1>
