      ...
      <div className="md:hidden flex text-black  h-full bg-[#FAE1C0] items-center flex-col">
         <div className=" mt-4  w-44">
          <img src="/iphone (1).png"></img>
                ...
                <div className="self-center mt-6"> <Image alt="our service image" src={'/magnifying-glass.png'} width={40} height={40}></Image></div>
                 ...
                 <div className="self-center mt-10"> <Image alt="our service image" src={'/suitcase.png'} width={40} height={40}></Image></div>
                 ...
                 <div className="self-center mt-10"> <Image alt="our service image" src={'/verify.png'} width={40} height={40}></Image></div>
                 ...
                 <div className="self-center mt-10"> <Image alt="our service image" src={'/magnifying-glass.png'} width={40} height={40}></Image></div>
