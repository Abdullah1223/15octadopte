...
//               className="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent shadow-sm text-gray-800"
...
'use client';
import React, { useState, useEffect } from 'react';
import { Filter, Search, MapPin, Clock, DollarSign, Briefcase, Bookmark, X, ChevronDown, Star, AlertCircle, ArrowRight, Sparkles, Globe } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import JobCard from '../DashboardComponents/JobCard';
import FeaturedJobCard from '../Components/FeaturedJobCard';
import Navbar from '../Components/Navbar';
          ...
          >
            <div className="p-5 md:p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700 flex items-center">
                    <Globe size={16} className="mr-1 text-orange-400" />
                    {translate('region')}
                  </label>
                  <select 
                    className="w-full p-2 border border-gray-200 rounded-md focus:ring-2 focus:ring-orange-400 focus:border-transparent bg-gray-50"
                  ...
                  >
                    <option value="">{translate('select_region')}</option>
                ...
                {/* <div className="space-y-2">
                  ...
                  <select 
                    ...
                    onChange={(e) => handleFilterChange('location', e.target.value)}
                  >
                    <option value="">{translate('any_city')}</option>
                    {locations.map((location, index) => (
                      <option key={index} value={location}>{location}</option>
                    ))}
                  </select>
