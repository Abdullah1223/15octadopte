...
// Clean User Card Component

// Main App Component
const JobSearchApp = () => {
  const [users, setUsers] = useState<UserCvInterface[]>([]);
 ...
 useEffect(()=>{
  console.log('Cv User STtaus',selector.isUserLoggedIn)
  if(selector.isUserLoggedIn==false){
    setPageLoading(false)
    setShowDialog(true)
    setRoleError(false)
    console.log(selector.isUserLoggedIn)
  }else if(selector.isUserLoggedIn==null){
    setPageLoading(false)
    setShowDialog(true)
    setRoleError(false)
  }
